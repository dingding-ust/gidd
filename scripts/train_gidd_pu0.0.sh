...
#SBATCH -o /scratch/PI/makchen/ddingab/gidd/logs/gidd-train-pu0.0_%j.out  # 标准输出日志
#SBATCH -e /scratch/PI/makchen/ddingab/gidd/logs/gidd-train-pu0.0_%j.err  # 标准错误日志
